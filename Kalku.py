...
# Format bilangan menjadi string dengan pemisah ribuan
loan_amount_formatted = locale.format_string("%d", loan_amount, grouping=True)

# Tampilkan jumlah pinjaman dengan format yang sesuai
st.write(f"Jumlah pinjaman: Rp{loan_amount_formatted}")
